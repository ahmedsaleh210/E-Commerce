class InCartsModelDataCartItemsProduct {
/*
{
  "id": 52,
  "price": 25000,
...
*/
  ...
  InCartsModelDataCartItemsProduct.fromJson(Map<String, dynamic> json) {
    id = json["id"]?.toInt();
...
*/
  ...
  int? id;
  int? quantity;
  InCartsModelDataCartItemsProduct? product;

  InCartsModelDataCartItems.fromJson(Map<String, dynamic> json) {
    id = json["id"]?.toInt();
    quantity = json["quantity"]?.toInt();
    product = (json["product"] != null) ? InCartsModelDataCartItemsProduct.fromJson(json["product"]) : null;
  }
}
...
*/
  ...
  InCartsModel.fromJson(Map<String, dynamic> json) {
    ...
    data = (json["data"] != null) ? InCartsModelData.fromJson(json["data"]) : null;
  }
}
